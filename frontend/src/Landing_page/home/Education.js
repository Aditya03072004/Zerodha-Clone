        ...
        <div className='container p-5'>
            <div className='row p-5'>
                ...
                <div className='col-6'>
                    ...
                    <p style={{fontSize:'105%'}}>Varsity, the largest online stock market education book in the world covering everything from the basics to advanced trading.</p>
                    <a href='' style={{textDecoration:"none"}}>Varsity <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>

                     <p className='mt-5' style={{fontSize:'105%'}}>TradingQ&A, the most active trading and investment community in India for all your market related queries.</p>
