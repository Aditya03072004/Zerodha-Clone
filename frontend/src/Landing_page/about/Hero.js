...
function Hero() {
    return ( 
        <div className='container'>
            <h1 className='p-5 mt-5 fs-2 text-center' style={{marginLeft:"16%", marginRight:"14%"}}>We pioneered the discount broking model in India.<br/>
            Now, we are breaking ground with our technology.</h1>
            <div className='row p-5 mt-5 border-top text-muted' style={{marginLeft:"11%", marginRight:"9%"}}>
                <div className='col-6 p-3 mt-5' style={{fontSize:"110%"}}>
                    <p>
                ...
                <div className='col-6 p-3 mt-5'style={{fontSize:"110%", textDecoration:"none"}}>
                    <p>
